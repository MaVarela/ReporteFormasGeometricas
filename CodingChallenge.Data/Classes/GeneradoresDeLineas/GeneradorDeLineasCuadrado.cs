...
{
    /// <summary>
    /// Clase generadora de líneas de texto para los cuadrados
    /// </summary>
    public class GeneradorDeLineasCuadrado : GeneradorDeLineas
    {
        /// <summary>
        ...
        public override string ObtenerLinea(int cantidad, decimal area, decimal perimetro, string tipo, int idioma)
        {
            ...
            var contador = contadorResolver.GetContador(tipo) as ContadorCuadrados;
